...
namespace Polaby.Repositories.Common
{
	public class UnitOfWork : IUnitOfWork
	{
        ...
        public UnitOfWork(AppDbContext dbContext, IAccountRepository accountRepository, IMenuRepository menuRepository, IMenuMealRepository menuMealRepository, ICommuntityPostRepository communtityPostRepository, IMealRepository mealRepository, IMealDishRepository mealDishRepository
            )
		{
